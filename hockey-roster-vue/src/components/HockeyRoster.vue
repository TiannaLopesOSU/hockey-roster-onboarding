<template>
  <body>
    <div id="app">
      ...
      >
        Sort By Jersey Number Descending
      </button>
      ...
      <div class="dropdown m-2">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
          <a
            class="dropdown-item"
            href="#"
            v-on:click="filterByPosition('Forward')"
            >Forward</a
          >
          <a
            class="dropdown-item"
            href="#"
            v-on:click="filterByPosition('Defense')"
            >Defense</a
          >
          <a
            class="dropdown-item"
            href="#"
            v-on:click="filterByPosition('Goalie')"
            >Goalie</a
          >
        </div>
      </div>
      ...
      <form class="m-2">
        <div class="form-group review-form" @submit.prevent="onSubmit">
          ...
          <input
            ...
            class="form-control"
            id="playerName"
            placeholder="Jimmy Jones"
            v-model="playerName"
            :class="{ invalid: playerName === '' && submitted === true }"
          />
          <div
            class="error-message"
            v-if="playerName === '' && submitted === true"
          >
        ...
        <div class="form-group">
          ...
          <input
            ...
            :class="{ invalid: jerseyNumber === '' && submitted === true }"
          />
          <div
            class="error-message"
            v-if="jerseyNumber === '' && submitted === true"
          >
        ...
        <div class="form-group">
          ...
          <input
            ...
            placeholder="65"
            v-model="gamesPlayed"
            :class="{ invalid: gamesPlayed === '' && submitted === true }"
          />
          <div
            class="error-message"
            v-if="gamesPlayed === '' && submitted === true"
          >
        ...
        <div class="form-group">
          ...
          <input
            ...
            placeholder="23"
            v-model="goals"
            :class="{ invalid: goals === '' && submitted === true }"
          />
          <div class="error-message" v-if="goals === '' && submitted === true">
            Goals are required.
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <input
            ...
            placeholder="63"
            v-model="assists"
            :class="{ invalid: assists === '' && submitted === true }"
          />
          <div
            class="error-message"
            v-if="assists === '' && submitted === true"
          >
            Assists are required.
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <input
            ...
            placeholder="86"
            v-model="points"
            :class="{ invalid: points === '' && submitted === true }"
          />
          <div class="error-message" v-if="points === '' && submitted === true">
            Points are required.
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <input
            ...
            id="penaltyMinutes"
            placeholder="98"
            v-model="penaltyMinutes"
            :class="{ invalid: penaltyMinutes === '' && submitted === true }"
          />
          <div
            class="error-message"
            v-if="penaltyMinutes === '' && submitted === true"
          >
            Penalty Minutes are required.
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <input
            ...
            placeholder="312"
            v-model="shotsOnGoal"
            :class="{ invalid: shotsOnGoal === '' && submitted === true }"
          />
          <div
            class="error-message"
            v-if="shotsOnGoal === '' && submitted === true"
          >
            Shots on goal are required.
          </div>
        </div>
  ...
  methods: {
    ...
    formIsValid(newPlayer) {
      if (
        ...
        newPlayer.assists === "" ||
        newPlayer.points === "" ||
        newPlayer.penaltyMinutes === "" ||
        newPlayer.shotsOnGoal === "" ||
        newPlayer.gameWinningGoals === ""
      ) {
        // first invalid case
        return false;
        ...
        // second invalid case
        alert(
          "That jersey number is already in use. Please change it and try again."
        );
        return false;
      } else {
        // only case valid
